...
bool GossipHello_ProfessionNPC(Player* pPlayer, Creature* pCreature)
{
	...
	if(SD2Config.GetBoolDefault("ProfessionNPC.OnlyGMs", false)) // If ProfessionNPC.OnlyGMs is enabled in scriptdev2.conf
	...
	bool EnableProfessions = SD2Config.GetBoolDefault("ProfessionNPC.EnableProfessions", true);
	bool EnableSecondarySkills = SD2Config.GetBoolDefault("ProfessionNPC.EnableSecondarySkills", true);
...
//Mony Check
if (pPlayer->GetMoney() < (SD2Config.GetFloatDefault("SkillGoldCost",0)))
{
    pPlayer->CLOSE_GOSSIP_MENU();
...
case 1001: // Alchemy
	...
	pPlayer->UpdateSkill(171,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1002: // Blacksmithing
	...
	pPlayer->UpdateSkill(164,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1003: // Enchanting
	...
	pPlayer->UpdateSkill(333,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1004: // Engineering
	...
	pPlayer->UpdateSkill(202,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1005: // Herbalism
	...
	pPlayer->UpdateSkill(182,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1006: // Inscription
	...
	pPlayer->UpdateSkill(773,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1007: // Jewelcrafting
	...
	pPlayer->UpdateSkill(755,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1008: // Leatherworking
	...
	pPlayer->UpdateSkill(165,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1009: // Mining
	...
	pPlayer->UpdateSkill(186,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1010: // Skinning
	...
	pPlayer->UpdateSkill(393,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 1011: // Tailoring
	...
	pPlayer->UpdateSkill(197,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 2001: // Cooking
	...
	pPlayer->UpdateSkill(185,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 2002: // First Aid
	...
	pPlayer->UpdateSkill(129,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
case 2003: // Fishing
	...
	pPlayer->UpdateSkill(356,(SD2Config.GetFloatDefault("SkillPoints",0)));
	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
	pPlayer->CLOSE_GOSSIP_MENU();
break;
...
//	}
//
//	pPlayer->UpdateSkill(,(SD2Config.GetFloatDefault("SkillPoints",0)));
//	pPlayer->ModifyMoney(-(SD2Config.GetFloatDefault("SkillGoldCost",0)));
//	pPlayer->CLOSE_GOSSIP_MENU();
//break;
