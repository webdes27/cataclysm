...
bool GossipHello_BuffNPC(Player* pPlayer, Creature* pCreature)
{
	...
	if(TScriptConfig.GetBoolDefault("BuffNPC.OnlyGMs", false)) // If BuffNPC.OnlyGMs is enabled in trinitycore.conf
	...
	bool EnableSmallBuff = TScriptConfig.GetBoolDefault("BuffNPC.EnableSmallBuff", true);
	bool EnableGreatBuff = TScriptConfig.GetBoolDefault("BuffNPC.EnableGreatBuff", true);
	bool EnableGMBuff = TScriptConfig.GetBoolDefault("BuffNPC.EnableGMBuff", true);
	bool EnablePlayerTools = TScriptConfig.GetBoolDefault("BuffNPC.EnablePlayerTools", true);
	bool EnableResSickness = TScriptConfig.GetBoolDefault("BuffNPC.EnableRemoveResSickness", true);
	bool EnableGivemeGold = TScriptConfig.GetBoolDefault("BuffNPC.EnableGivemeGold", false);
