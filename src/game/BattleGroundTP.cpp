...
void BattleGroundTP::HandleAreaTrigger(Player *Source, uint32 Trigger)
{
    ...
    switch(Trigger)
    {
        case 5911:                                          // Left Alliance elixir of regeneration spawn
        case 5909:                                          // Right Alliance elixir of berserk spawn
		case 5910:                                          // Left Horde elixir of regeneration spawn
		case 5908:                                          // Right Horde elixir of berserk spawn
            break;
        ...
        case 5905:                                          // Horde Flag spawn
            if (m_FlagState[BG_TEAM_ALLIANCE] && !m_FlagState[BG_TEAM_HORDE])
                if (GetAllianceFlagPickerGUID() == Source->GetGUID())
                    EventPlayerCapturedFlag(Source);
            break;
        case 5921:                                          // Horde Base Left Side
        case 5918:                                          // Horde Base Right Side
        case 5920:                                          // Horde Base Front Side
        case 5917:                                          // Alliance Base Left Side
        case 5914:                                          // Alliance Base Right Side
        case 5916:                                          // Alliance Base Front Side
            break;
        default:
