...
void LoadDBCStores(const std::string& dataPath)
{
    ...
    if( !sAreaStore.LookupEntry(4058)              ||       // last area (areaflag) added in 4.0.0-12122
        !sCharTitlesStore.LookupEntry(187)         ||       // last char title added in 4.0.0-12122
        !sGemPropertiesStore.LookupEntry(1823)     ||       // last gem property added in 4.0.0-12122
        !sItemStore.LookupEntry(59337)             ||       // last client known item added in 4.0.0-12122
        !sItemExtendedCostStore.LookupEntry(2999)  ||       // last item extended cost added in 4.0.0-12122
        !sMapStore.LookupEntry(750)                ||       // last map added in 4.0.0-12122
        !sSpellStore.LookupEntry(81625)            )        // last added spell in 4.0.0-12122
    {
