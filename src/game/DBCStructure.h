...
struct SpellEntry
{
    ...
    DBCString SpellName;                                    // 136-151  m_name_lang
    DBCString Rank;                                         // 153-168  m_nameSubtext_lang
    //DBCString Description;                                // 170-185  m_description_lang not used
    //DBCString ToolTip;                                    // 187-202  m_auraDescription_lang not used
