...
enum Opcodes
{
    ...
    CMSG_PLAYER_LOGOUT                              = 0xa96e, //0x04A,
    CMSG_LOGOUT_REQUEST                             = 0xdb67,
    SMSG_LOGOUT_RESPONSE                            = 0x5b65,
    SMSG_LOGOUT_COMPLETE                            = 0x8f61,
    CMSG_LOGOUT_CANCEL                              = 0x04E,
    SMSG_LOGOUT_CANCEL_ACK                          = 0x79ef,
    CMSG_NAME_QUERY                                 = 0x0be5,
    SMSG_NAME_QUERY_RESPONSE                        = 0x1964,
    CMSG_PET_NAME_QUERY                             = 0x3fe2,
    SMSG_PET_NAME_QUERY_RESPONSE                    = 0x7d6e,
    CMSG_GUILD_QUERY                                = 0xf9ef,
    SMSG_GUILD_QUERY_RESPONSE                       = 0xcd6e,
    CMSG_ITEM_QUERY_SINGLE                          = 0xdd6e,
    CMSG_ITEM_QUERY_MULTIPLE                        = 0x2f6b,
    SMSG_ITEM_QUERY_SINGLE_RESPONSE                 = 0x6f6b,
    SMSG_ITEM_QUERY_MULTIPLE_RESPONSE               = 0xed6d,
    CMSG_PAGE_TEXT_QUERY                            = 0x0de0,
    SMSG_PAGE_TEXT_QUERY_RESPONSE                   = 0xe9e0,
    CMSG_QUEST_QUERY                                = 0x6b62,
    SMSG_QUEST_QUERY_RESPONSE                       = 0xeb66,
    CMSG_GAMEOBJECT_QUERY                           = 0xad62,
    ...
    SMSG_UPDATE_OBJECT                              = 0x3de2,
    SMSG_DESTROY_OBJECT                             = 0x2f60,
    CMSG_USE_ITEM                                   = 0x0AB,
    ...
    MSG_MOVE_START_FORWARD                          = 0x1fe8,
    MSG_MOVE_START_BACKWARD                         = 0x2fe1,
    MSG_MOVE_STOP                                   = 0xfd6f,
    MSG_MOVE_START_STRAFE_LEFT                      = 0x39e7,
    MSG_MOVE_START_STRAFE_RIGHT                     = 0x9fe5,
    MSG_MOVE_STOP_STRAFE                            = 0x1dee,
    MSG_MOVE_JUMP                                   = 0x9f6a,
    MSG_MOVE_START_TURN_LEFT                        = 0x4d69,
    MSG_MOVE_START_TURN_RIGHT                       = 0x5dea,
    MSG_MOVE_STOP_TURN                              = 0xefe6,
    MSG_MOVE_START_PITCH_UP                         = 0xa9e2,
    MSG_MOVE_START_PITCH_DOWN                       = 0xfd63,
    MSG_MOVE_STOP_PITCH                             = 0x796a,
    MSG_MOVE_SET_RUN_MODE                           = 0x7de1,
    MSG_MOVE_SET_WALK_MODE                          = 0x2fe7,
    MSG_MOVE_TOGGLE_LOGGING                         = 0x0C4,
    MSG_MOVE_TELEPORT                               = 0x8de4,
    MSG_MOVE_TELEPORT_CHEAT                         = 0x0C6,
    MSG_MOVE_TELEPORT_ACK                           = 0xb9e7,
    MSG_MOVE_TOGGLE_FALL_LOGGING                    = 0x0C8,
    MSG_MOVE_FALL_LAND                              = 0x6be7,
    MSG_MOVE_START_SWIM                             = 0x7fef,
    MSG_MOVE_STOP_SWIM                              = 0xede3,
    MSG_MOVE_SET_RUN_SPEED_CHEAT                    = 0x0CC,
    MSG_MOVE_SET_RUN_SPEED                          = 0xcb68,
    MSG_MOVE_SET_RUN_BACK_SPEED_CHEAT               = 0x0CE,
    MSG_MOVE_SET_RUN_BACK_SPEED                     = 0xffe1,
    MSG_MOVE_SET_WALK_SPEED_CHEAT                   = 0x0D0,
    MSG_MOVE_SET_WALK_SPEED                         = 0xab61,
    MSG_MOVE_SET_SWIM_SPEED_CHEAT                   = 0x0D2,
    MSG_MOVE_SET_SWIM_SPEED                         = 0x6fe0,
    MSG_MOVE_SET_SWIM_BACK_SPEED_CHEAT              = 0x0D4,
    MSG_MOVE_SET_SWIM_BACK_SPEED                    = 0x5be5,
    MSG_MOVE_SET_ALL_SPEED_CHEAT                    = 0x0D6,
    MSG_MOVE_SET_TURN_RATE_CHEAT                    = 0x0D7,
    MSG_MOVE_SET_TURN_RATE                          = 0x8d6c,
    MSG_MOVE_TOGGLE_COLLISION_CHEAT                 = 0x89ee,
    MSG_MOVE_SET_FACING                             = 0xef6c,
    MSG_MOVE_SET_PITCH                              = 0x2d6a,
    MSG_MOVE_WORLDPORT_ACK                          = 0xcf64,
    SMSG_MONSTER_MOVE                               = 0x1be2,
    SMSG_MOVE_WATER_WALK                            = 0x79e7,
    SMSG_MOVE_LAND_WALK                             = 0x1f62,
    MSG_MOVE_SET_RAW_POSITION_ACK                   = 0x0E0,
    CMSG_MOVE_SET_RAW_POSITION                      = 0x0E1,
    SMSG_FORCE_RUN_SPEED_CHANGE                     = 0x9968,
    ...
    SMSG_FORCE_MOVE_UNROOT                          = 0xdfe0,
    CMSG_FORCE_MOVE_UNROOT_ACK                      = 0x0EB,
    MSG_MOVE_ROOT                                   = 0xdf67,
    MSG_MOVE_UNROOT                                 = 0x2fec,
    MSG_MOVE_HEARTBEAT                              = 0xad6e,
    SMSG_MOVE_KNOCK_BACK                            = 0x6b61,
    CMSG_MOVE_KNOCK_BACK_ACK                        = 0x0F0,
    MSG_MOVE_KNOCK_BACK                             = 0x1fe9,
    SMSG_MOVE_FEATHER_FALL                          = 0x296e,
    ...
    SMSG_CLIENT_CONTROL_UPDATE                      = 0x3dea,
    ...
    CMSG_NPC_TEXT_QUERY                             = 0xcbe8,
    SMSG_NPC_TEXT_UPDATE                            = 0x6ded,
    ...
    CMSG_QUERY_TIME                                 = 0xf967,
    SMSG_QUERY_TIME_RESPONSE                        = 0x3d6b,
    SMSG_LOG_XPGAIN                                 = 36841,
    ...
    CMSG_GMTICKET_GETTICKET                         = 0x6b6e,
    SMSG_GMTICKET_GETTICKET                         = 0x8d69,
    ...
    SMSG_GMTICKET_DELETETICKET                      = 0x9b60,
    ...
    CMSG_ITEM_TEXT_QUERY                            = 0xab64,
    SMSG_ITEM_TEXT_QUERY_RESPONSE                   = 0xf9e2,
    ...
    MSG_QUERY_NEXT_MAIL_TIME                        = 0x6fe1,
    ...
    CMSG_MEETINGSTONE_INFO                          = 0x3b60, // EVENT_LFG_UPDATE
    ...
    SMSG_CANCEL_AUTO_REPEAT                         = 0x2d64,
    SMSG_STANDSTATE_UPDATE                          = 0x1960,
    ...
    SMSG_MONSTER_MOVE_TRANSPORT                     = 0x3969,
    SMSG_PET_BROKEN                                 = 0x2AF,
    MSG_MOVE_FEATHER_FALL                           = 0x49e2,
    MSG_MOVE_WATER_WALK                             = 0xfbe3,
    ...
    SMSG_RAID_INSTANCE_INFO                         = 39264,
    CMSG_REQUEST_RAID_INFO                          = 0x9b6a,
    CMSG_MOVE_TIME_SKIPPED                          = 0x9fea,
    CMSG_MOVE_FEATHER_FALL_ACK                      = 0x2CF,
    CMSG_MOVE_WATER_WALK_ACK                        = 0x2D0,
    CMSG_MOVE_NOT_ACTIVE_MOVER                      = 0x2D1,
    SMSG_PLAY_SOUND                                 = 0xbb67,
    CMSG_BATTLEFIELD_STATUS                         = 0x2be4,
    ...
    SMSG_FORCE_WALK_SPEED_CHANGE                    = 0x1deb,
    CMSG_FORCE_WALK_SPEED_CHANGE_ACK                = 0x2DB,
    SMSG_FORCE_SWIM_BACK_SPEED_CHANGE               = 0x9bee,
    CMSG_FORCE_SWIM_BACK_SPEED_CHANGE_ACK           = 0x2DD,
    SMSG_FORCE_TURN_RATE_CHANGE                     = 0xbbee,
    ...
    SMSG_RAID_INSTANCE_MESSAGE                      = 55657,
    SMSG_COMPRESSED_MOVES                           = 0x49e0,
    CMSG_GUILD_INFO_TEXT                            = 0x2FC,
    SMSG_CHAT_RESTRICTED                            = 0x2FD,
    SMSG_SPLINE_SET_RUN_SPEED                       = 0x7bec,
    SMSG_SPLINE_SET_RUN_BACK_SPEED                  = 0xade1,
    SMSG_SPLINE_SET_SWIM_SPEED                      = 0xcdef,
    SMSG_SPLINE_SET_WALK_SPEED                      = 0xeb69,
    SMSG_SPLINE_SET_SWIM_BACK_SPEED                 = 0x8bed,
    SMSG_SPLINE_SET_TURN_RATE                       = 0x1f67,
    SMSG_SPLINE_MOVE_UNROOT                         = 0x4f6e,
    SMSG_SPLINE_MOVE_FEATHER_FALL                   = 0x7be8,
    SMSG_SPLINE_MOVE_NORMAL_FALL                    = 0x9dea,
    SMSG_SPLINE_MOVE_SET_HOVER                      = 0xfb6b,
    SMSG_SPLINE_MOVE_UNSET_HOVER                    = 0xf9e0,
    SMSG_SPLINE_MOVE_WATER_WALK                     = 0x39ec,
    SMSG_SPLINE_MOVE_LAND_WALK                      = 0x2d65,
    SMSG_SPLINE_MOVE_START_SWIM                     = 0xafe2,
    SMSG_SPLINE_MOVE_STOP_SWIM                      = 0x1b65,
    SMSG_SPLINE_MOVE_SET_RUN_MODE                   = 0x9de9,
    SMSG_SPLINE_MOVE_SET_WALK_MODE                  = 0x296f,
    ...
    SMSG_EXPECTED_SPAM_RECORDS                      = 0x3fe3,
    ...
    SMSG_DEFENSE_MESSAGE                            = 36331,
    SMSG_INSTANCE_DIFFICULTY                        = 0x7f60,
    MSG_GM_RESETINSTANCELIMIT                       = 0x33C,
    SMSG_MOTD                                       = 0x8be6,
    SMSG_MOVE_SET_FLIGHT                            = 0xebef,
    SMSG_MOVE_UNSET_FLIGHT                          = 0x4fe8,
    CMSG_MOVE_FLIGHT_ACK                            = 0x340,
    MSG_MOVE_START_SWIM_CHEAT                       = 0x6960,
    MSG_MOVE_STOP_SWIM_CHEAT                        = 0x5f62,
    SMSG_MOVE_SET_CAN_FLY                           = 0xe965,
    SMSG_MOVE_UNSET_CAN_FLY                         = 0xcde8,
    CMSG_MOVE_SET_CAN_FLY_ACK                       = 0xc9e9,
    CMSG_MOVE_SET_FLY                               = 0x346,
    CMSG_SOCKET_GEMS                                = 0x347,
    CMSG_ARENA_TEAM_CREATE                          = 0x348,
    SMSG_ARENA_TEAM_COMMAND_RESULT                  = 0x349,
    UMSG_UPDATE_ARENA_TEAM_OBSOLETE                 = 0xb96e,
    CMSG_ARENA_TEAM_QUERY                           = 0x7960,
    SMSG_ARENA_TEAM_QUERY_RESPONSE                  = 0x1d69,
    ...
    MSG_MOVE_START_ASCEND                           = 0x8b61,
    MSG_MOVE_STOP_ASCEND                            = 0xdbe3,
    ...
    CMSG_LFD_PLAYER_LOCK_INFO_REQUEST               = 0x1b6c,    // CMSG RequestLFDPlayerLockInfo
    ...
    MSG_MOVE_SET_FLIGHT_SPEED                       = 0xef66,
    MSG_MOVE_SET_FLIGHT_BACK_SPEED_CHEAT            = 0x37F,
    MSG_MOVE_SET_FLIGHT_BACK_SPEED                  = 0x4965,
    SMSG_FORCE_FLIGHT_SPEED_CHANGE                  = 0x09e6,
    CMSG_FORCE_FLIGHT_SPEED_CHANGE_ACK              = 0x09e1,
    SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE             = 0xade6,
    CMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK         = 0x384,
    SMSG_SPLINE_SET_FLIGHT_SPEED                    = 0xef60,
    SMSG_SPLINE_SET_FLIGHT_BACK_SPEED               = 0x59ee,
    CMSG_MAELSTROM_INVALIDATE_CACHE                 = 0x387,
    SMSG_FLIGHT_SPLINE_SYNC                         = 0x7fe9,
    ...
    SMSG_CHANNEL_MEMBER_COUNT                       = 0x19e1,
    ...
    SMSG_COMSAT_RECONNECT_TRY                       = 14830,
    SMSG_COMSAT_DISCONNECT                          = 23533,
    SMSG_COMSAT_CONNECT_FAIL                        = 8042,
    SMSG_VOICE_CHAT_STATUS                          = 14698,
    ...
    SMSG_USERLIST_ADD                               = 11752,
    SMSG_USERLIST_REMOVE                            = 59887,
    SMSG_USERLIST_UPDATE                            = 16367,
    ...
    CMSG_QUESTGIVER_STATUS_MULTIPLE_QUERY           = 0x8b6a,
    ...
    SMSG_SPLINE_MOVE_SET_FLYING                     = 0x0be2,
    SMSG_SPLINE_MOVE_UNSET_FLYING                   = 0xebed,
    ...
    CMSG_CALENDAR_GET_NUM_PENDING                   = 0xc964,
    ...
    CMSG_DANCE_QUERY                                = 0x7b6e,
    SMSG_DANCE_QUERY_RESPONSE                       = 0xfd61,
    SMSG_INVALIDATE_DANCE                           = 0xbde8,
    ...
    MSG_MOVE_SET_PITCH_RATE                         = 0xd9ea,
    SMSG_FORCE_PITCH_RATE_CHANGE                    = 0xede9,
    CMSG_FORCE_PITCH_RATE_CHANGE_ACK                = 0x45D,
    SMSG_SPLINE_SET_PITCH_RATE                      = 0xcf6d,
    ...
    SMSG_ACHIEVEMENT_EARNED                         = 0xbfe0,
    SMSG_DYNAMIC_DROP_ROLL_RESULT                   = 0x469,
    SMSG_CRITERIA_UPDATE                            = 0x7f66,
    ...
    SMSG_HEALTH_UPDATE                              = 0xafe9,
    SMSG_POWER_UPDATE                               = 0x89e6,
    CMSG_GAMEOBJ_REPORT_USE                         = 0x481,
    SMSG_HIGHEST_THREAT_UPDATE                      = 0xddec,
    SMSG_THREAT_UPDATE                              = 0x69e4,
    SMSG_THREAT_REMOVE                              = 0x6fe7,
    SMSG_THREAT_CLEAR                               = 0x4964,
    ...
    SMSG_PRE_RESURRECT                              = 0x5fe4,
    SMSG_AURA_UPDATE_ALL                            = 0xff6a,
    SMSG_AURA_UPDATE                                = 0x99e6,
    CMSG_FLOOD_GRACE_CHEAT                          = 0x497,
    SMSG_SERVER_FIRST_ACHIEVEMENT                   = 61289,
    ...
    SMSG_CRITERIA_DELETED                           = 0x8de1, // not changed 9626
    SMSG_ACHIEVEMENT_DELETED                        = 0xdde9, // not changed 9626
    ...
    SMSG_PLAYER_VEHICLE_DATA                        = 0x5b61, // smsg guid+uint32 (vehicle) EVENT_PLAYER_GAINS_VEHICLE_DATA/EVENT_PLAYER_LOSES_VEHICLE_DATA
    ...
    SMSG_MULTIPLE_PACKETS                           = 0xcdea, // SMSG, handles any opcode
    SMSG_FORCE_UNK1_SPEED_CHANGE                    = 0xfb66, // SMSG, movement related
    CMSG_FORCE_UNK1_SPEED_CHANGE_ACK                = 0x4CF, // movement related
    SMSG_FORCE_UNK2_SPEED_CHANGE                    = 0x5f6c, // SMSG, movement related
    ...
    SMSG_GMRESPONSE_DB_ERROR                        = 0x0961, // empty
    SMSG_GMRESPONSE_RECEIVED                        = 0x5961, // uint32, uint32, string[2000], string[4000][4]
    CMSG_GMRESPONSE_RESOLVE                         = 0x4F0, // lua: GMResponseResolve
    SMSG_GMRESPONSE_STATUS_UPDATE                   = 0xc96b, // uint8 (1 - EVENT_GMSURVEY_DISPLAY, 0 - EVENT_UPDATE_TICKET)
    ...
    CMSG_WORLD_STATE_UI_TIMER_UPDATE                = 0x0b61,
    ...
    SMSG_QUERY_QUESTS_COMPLETED_RESPONSE            = 0x696c, // response to CMSG_QUERY_QUESTS_COMPLETED
    ...
    SMSG_FORCE_SEND_QUEUED_PACKETS                  = 0xd960, //
    ...
    SMSG_UNKNOWN_1302                               = 0x596e, // something with player movement (move event 58?)
    CMSG_UNKNOWN_1303                               = 0x517, // something with player movement (move event 58?)
    SMSG_UNKNOWN_1304                               = 0x4fe0, // something with player movement (move event 58?), speed packet
    ...
    SMSG_UNKNOWN_1310                               = 0x8beb, // ERR_ALTERED_FORM_CANT_TRANSFORM_RIGHT_NOW or ERR_ALTERED_FORM_CAN_NEVER_TRANSFORM
    SMSG_UNKNOWN_1311                               = 0x6be4, // related to transform
    SMSG_UNKNOWN_1312                               = 0x1d6d, // related to transform
    UMSG_UNKNOWN_1313                               = 0x521, // not found
    SMSG_UNKNOWN_1314                               = 0xfde7, // sets unit+4336 to value from packet
    SMSG_UNKNOWN_1315                               = 0x0de4, // related to opcode 0x522
    SMSG_UNKNOWN_1316                               = 0x0960, // sets unit+4338 to value from packet
