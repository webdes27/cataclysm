...
//              damage = m_caster->SpellDamageBonus(m_caster, m_spellInfo,uint32(damage > 0 ? damage : 0), SPELL_DIRECT_DAMAGE);
        ...
        case SPELLFAMILY_ROGUE:
        {
            switch(m_spellInfo->Id)
            {
				...
				case 51662:                                 // Hunger for Blood (req MECHANIC_BLEED)
                {
            ...
            {  
                ...
                case 49576:
                {
                    ...
                    {  
                        ...
                        ((Creature*)unitTarget)->SendMonsterMove(x, y, z, SPLINETYPE_NORMAL, SPLINEFLAG_UNKNOWN11, 1); // replaced old MONSTER_MOVE_UNK12
                    }
                    else
